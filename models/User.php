...
class User
{
    ...
    public function update(){
        ...
        $sql = "UPDATE users SET name=?, username =?, email=?, password=?, profile_image = ?, role = ?";
        $stmt = $this->conn->prepare($sql);
        $stmt->bind_param("ssssss", $this->name,$this->email,$this->password,$this->profile_image,$this->role);
        $stmt->execute();
